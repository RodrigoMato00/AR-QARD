var dict = [{'1e7c0797-be4e-4e62-8e14-c5156866545f': {'fullname': 'Rodrigo Mato', 'email': 'rodrigomato.rm@gmail.com', 'phone': '094041426', 'user_position': 'Software Engineer', 'web_page': 'https://github.com/RodrigoMato00/AR-QARD/blob/master/resources/models/Rodrigo_Mato-Resum%20(1).pdf', 'linkedin': 'https://www.linkedin.com/in/rodrigo-mato-pla/', 'github': 'https://github.com/RodrigoMato00', 'instagram': 'https://www.instagram.com/rodrigomfg/', 'about_you': 'Plan, design and develop software projects. Provide support when required to technical software and hardware problems. Propose ideas and and analyze the requirements to carry them out. Responsible forprogress, execute and maintain the software projects carried out. software projects', 'facebook': '', 'twitter': '', 'behance': '', 'slack': '', 'marker': 2, 'button_color': '#052187', 'icon_color': '#FFFFFF'}}, {'1e7c0797-be4e-4e62-8e14-c995858j4949585': {'fullname': 'Marcelo Arbiza', 'email': 'arbizamar@gmail.com', 'phone': '092982997', 'user_position': 'Software Engineer', 'web_page': 'https://github.com/RodrigoMato00/AR-QARD/blob/master/resources/models/CV%20-%20Marcelo%20Arbiza.pdf', 'linkedin': 'https://www.linkedin.com/in/marceloarbiza/', 'github': 'https://github.com/Marceloarbiza', 'instagram': 'https://www.instagram.com/barra_32/', 'about_you': 'I am a creative and enthusiastic person. I am always in constant learning both in my technical skills and in my soft skills. To be a professional, you must master both. I like to work in a team and my approach is towards project management. Lover of new challenges.', 'facebook': '', 'twitter': '', 'behance': '', 'slack': '', 'marker': 3, 'button_color': '#09735B', 'icon_color': '#FFFFFF'}}];
                  ...
                  for (var key in dict[j]) {
                      ...
                      if (dict[j][key].marker == k + 1) {
                          ...
                          if (dict[j][key].icon_color == '#FFFFFF'){
                                  ...
                                  var Ph = 'resources/models/photo-'+ key +'.jpeg';
